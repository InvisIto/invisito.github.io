...
function App() {
  return <main className="page">
    <section className="hero-section">
      ...
      <div className="buttons"><a className="button" href="./invisito-paper.pdf"><span className="paper-icon" aria-hidden="true" />Paper</a><a className="button" href="#video"><span>▶</span>Video</a><a className="button" href="#bibtex"><span>&lt;/&gt;</span>BibTeX</a></div>
    </section>
